...
def build_workflow_from_parse_results(
    ...
    *,
    ...
    for r in resultados or []:
        ...
        leitura_anterior = _safe_str(periodo.get("leitura_anterior")) or _safe_str(_first_non_null(df_itens, "leitura_anterior"))
        leitura_atual = _safe_str(periodo.get("leitura_atual")) or _safe_str(_first_non_null(df_itens, "leitura_atual"))
        dias = _safe_int(periodo.get("dias"))
        if dias is None:
            dias = _safe_int(_first_non_null(df_itens, "dias"))
        proxima_leitura = _safe_str(periodo.get("proxima_leitura")) or _safe_str(_first_non_null(df_itens, "proxima_leitura"))
        nota_fiscal_serie = _safe_str(nf.get("serie")) or _safe_str(_first_non_null(df_itens, "serie"))
        nota_fiscal_emissao = _safe_str(nf.get("data_emissao")) or _safe_str(_first_non_null(df_itens, "data_emissao"))
