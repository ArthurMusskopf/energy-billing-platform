...
export function FaturaTable({
  ...
  const updateMainField = (faturaId: string, field: keyof Fatura, value: string | number) => {
    updateDraft(faturaId, (current) => {
      ...
      const cadastro = current.cadastro ? { ...current.cadastro } : undefined;
                    ...
                    <TableRow className="bg-muted/30 hover:bg-muted/30">
                      <TableCell colSpan={8} className="p-0">
                        <div className="space-y-4 p-6">
                          ...
                          {(pendingFields.length > 0 || fatura.motivo_bloqueio) && (
                            <div className="rounded-lg border border-warning/20 bg-warning/10 p-4">
                              <h4 className="font-semibold text-warning">Cadastro minimo pendente</h4>
                              <p className="mt-1 text-sm text-muted-foreground">
                                Preencha e salve o cadastro minimo dentro deste fluxo antes de calcular.
                              </p>
                              {fatura.motivo_bloqueio && (
                                <p className="mt-2 text-sm">{fatura.motivo_bloqueio}</p>
                              )}
                            ...
                            <div className="space-y-3 rounded-lg border bg-background p-4">
                              ...
                              <div className="grid gap-3 md:grid-cols-2">
                                ...
                                <FieldInput
                                  ...
                                  type="number"
                                  onChange={(value) =>
                                    updateMainField(fatura.id, "dias", value === "" ? 0 : Number(value))
                                  }
                                />
                                <FieldInput
                            ...
                            <div className="space-y-3 rounded-lg border bg-background p-4">
                              ...
                              <div className="grid gap-3 md:grid-cols-2">
                                ...
                                <FieldInput
                                  ...
                                  type="number"
                                  onChange={(value) =>
                                    updateCadastroField(fatura.id, "n_fases", value === "" ? null : Number(value))
                                  }
                                />
                                <FieldInput
                                  ...
                                  step="0.01"
                                  onChange={(value) =>
                                    updateCadastroField(fatura.id, "custo_disp", value === "" ? null : Number(value))
                                  }
                                />
                              </div>

                              <div className="flex flex-wrap gap-2 pt-2">
                                <Button type="button" variant="secondary" disabled={isSaving} onClick={() => onSaveReview(fatura)}>
                                  {isSaving ? (
                                    <>
                                ...
                                <Button type="button" disabled={isValidating || !canValidateAndCalculate} onClick={() => onValidateAndCalculate(fatura)}>
